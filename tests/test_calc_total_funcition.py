...
class Test_functions(unittest.TestCase):
    ...
    def test_calcular_total_function_12x24(self):
        ...
        # capture output test
        paga = op_ctotal(jor, factor_mult_extras, horas_trasncurridas, hs_por_jornada)
        self.assertEqual(paga , 137.5) # total of pay result

    def test_calcular_total_function_12x18(self):
        # test parameters
        jor = str(55)
        factor_mult_extras = 1.5
        horas_trasncurridas = 18
        hs_por_jornada = 12

        # capture output test
        paga = op_ctotal(jor, factor_mult_extras, horas_trasncurridas, hs_por_jornada)
        self.assertEqual(paga , 96.25) # total of pay result
    ...
    def test_tiempos_function(self):
        ...
        # capture output test
        horas_transcurridas = op_tiempos(dia_hora_entrada_dt, dia_hora_salida_dt, hs_por_jornada, hnocturno_checkbox)[2]
